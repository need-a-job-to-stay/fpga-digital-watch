...
module wave_user_top_timer_v3;
  ...
  initial begin
    $dumpfile("wave_user_top_timer_v3.vcd");
    $dumpvars(0, wave_user_top_timer_v3);

    // --- Normal operation: timer counts for ~1.5 simulated seconds ---
