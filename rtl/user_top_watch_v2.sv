...
module user_top_watch_v2 #(
  ...
  assign seconds_inc = button[1];
  assign minutes_inc = button[1];
  assign hours_inc = button[1];

  assign seconds_dec = button[0];
  assign minutes_dec = button[0];
  assign hours_dec = button[0];
