...
\end{reportbox}
I first implement Mode selection function because it is small and similar to watch part while count down function can not independenty work. If count down module independently running, time will start at 0 and can test count down function due to restriction.
\begin{reportbox}{Report 13}
...
\end{reportbox}
\section{Timer}\section{Timer}\section{Timer}
